...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3: 9번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 글이 존재하지 않아 댓글은 비어 있어야 합니다.");
        }
        ...
        /* Case 4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 글이 존재하지 않아 댓글은 비어 있어야 합니다.");
        }
        ...
        /* Case 5: -1번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 글이 존재하지 않아 댓글은 비어 있어야 합니다.");
        }
    }
